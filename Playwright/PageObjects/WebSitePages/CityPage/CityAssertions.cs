namespace PlaywrightRaffle.PageObjects
{
    public partial class City
    {
        ...
        public static async Task VerifyTopBannerTitle()
        {
            ...
            Assert.That(text.ToLower(), Is.EqualTo(CityTexts.TOP_TITLE.ToLower()), $"Texts are not matched. Expected \"{CityTexts.TOP_TITLE}\" but was \"{text}\"");
        ...
        public static async Task VerifyTopBannerSubtitle()
        {
            ...
            Assert.That(text.ToLower(), Is.EqualTo(CityTexts.TOP_SUBTITLE.ToLower()), $"Texts are not matched. Expected \"{CityTexts.TOP_SUBTITLE}\" but was \"{text}\"");
        ...
        public static async Task VerifyBottomSliderTitle()
        {
            ...
            Assert.That(text.ToLower(), Is.EqualTo(CityTexts.BOTTOM_SLIDER_TITLE.ToLower()), $"Texts are not matched. Expected \"{CityTexts.BOTTOM_SLIDER_TITLE}\" but was \"{text}\"");
        ...
        public static async Task VerifyBottomSliderSubitle()
        {
            ...
            {
                Assert.That(listOfText[i].TextContentAsync().Result.ToLower(), Is.EqualTo(CityTexts.BOTTOM_SLIDER_SUBTITLE[i].ToLower()), $"Texts are not matched. Expected \"{CityTexts.BOTTOM_SLIDER_SUBTITLE[i]}\" but was \"{listOfText[i].TextContentAsync().Result}\"");
            }
        ...
        public static async Task VerifyInfoBlockTitles()
        {
            ...
            for (int i = 0; i < CityTexts.TITLES_INFO_BLOCKS.Count; i++)
            {
                string expectedTitle = CityTexts.TITLES_INFO_BLOCKS[i].ToLower();
        ...
        public static async Task VerifyInfoBlockParagraphs()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                Assert.That(listOfText[i].TextContentAsync().Result.ToLower(), Is.EqualTo(CityTexts.PARAGRAPHS_INFO_BLOCKS[i].ToLower()), string.Concat("Not matched ", "\"", listOfText[i].TextContentAsync(), "\"", "\r\nwith ", "\"", CityTexts.PARAGRAPHS_INFO_BLOCKS[i], "\""));
            }
        ...
        public static async Task VerifyHowItWorksTitle()
        {
            ...
            Assert.That(text.ToLower(), Is.EqualTo(CityTexts.HOW_IT_WORKS_TITLE.ToLower()), $"Texts are not matched. Expected \"{CityTexts.HOW_IT_WORKS_TITLE}\" but was \"{text}\"");
        ...
        public static async Task VerifyHowItWorksParagraph()
        {
            ...
            Assert.That(text.ToLower(), Is.EqualTo(CityTexts.HOW_IT_WORKS_PARAGRAPH.ToLower()), $"Texts are not matched. Expected \"{CityTexts.HOW_IT_WORKS_PARAGRAPH}\" but was \"{text}\"");
        ...
        public static async Task VerifyHowItWorksStepsTitles()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Assert.That(text[i].Result.ToLower(), Is.EqualTo(CityTexts.TITLES_STEPS[i].ToLower()), $"Texts are not matched. Expected \"{CityTexts.TITLES_STEPS[i]}\" but was \"{text[i].Result}\"");
            }
        ...
        public static async Task VerifyHowItWorksStepsParagraphs()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                string expectedParagraph = CityTexts.PARAGRAPHS_STEPS[i].ToLower();
